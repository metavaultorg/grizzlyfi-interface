    ...
    <div className="MvlpSwap">
      <div className="MvlpSwap-content">
        <div className="App-card MvlpSwap-stats-card">
          <div className="App-card-title" style={{padding:"20px"}}>
            <div className="App-card-title-mark" style={{ justifyContent: "space-between", width: "100%" }}>
              <div className="App-card-title-mark-icon">
                <img style={{ width: 41, height: 41 }} src={mvlp40Icon} alt="mvlp40Icon" />
              </div>
              <div className="App-card-title-mark-info">
                <div className="App-card-title-mark-title">MVLP</div>
              </div>
              <div style={{ marginLeft: "auto", display:"flex", flexDirection: "column", alignItems:"flex-end"}}>
                <span style={{ fontSize: "15px", fontWeight: 600, color: "rgba(255, 255, 255, 0.5)" }}>Amplify your MVLP yield on</span>
                <a
              ...
              <div className="App-card-row">
                ...
                <div className="value">
                  <Tooltip
                    ...
                    renderContent={() => `${formatAmount(reservedAmount, 18, 4, true)} Reserved MVLP for vesting.`}
                  />
                </div>
              </div>
            )}
        ...
        <div className="MvlpSwap-box App-box basis-mobile">
          <Tab
            options={["+ LIQ.", "- LIQ."]}
            option={tabLabel}
                  ...
                  <div style={{ paddingLeft: 0 }} className="App-card-options">
                    {isBuying && (
                      <button
                        ...
                        className="App-button-option App-card-option text-uppercase"
                        onClick={() => selectToken(token)}
                      >
