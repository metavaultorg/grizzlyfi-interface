...
import earnedBigIcon from "../../assets/icons/earnIcon.png";
...
import VestingIcon from "../../assets/icons/VestingIcon.png";

import TotalEarning from "../../assets/icons/TotalEarning";

import { ethers } from "ethers";

import mvxIcon from "../../assets/icons/mvxCoinWithStars.png";
import mvlpIcon from "../../assets/icons/mvlpCoin.png";
import mvxVest from "../../assets/icons/mvxVesting.png";
import mvlpVest from "../../assets/icons/mvlpVest.png";
...
import { callContract, useMvxPrice, useTotalMvxStaked, useTotalMvxSupply, useInfoTokens } from "../../Api";
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        ...
        {burnAmount && burnAmount.gt(0) && rewardReductionBasisPoints && rewardReductionBasisPoints.gt(0) && (
          <div className="Modal-note">
            ...
            .&nbsp;
            {shouldShowReductionAmount && <span>Boost %: -{formatAmount(rewardReductionBasisPoints, 2, 2)}%.</span>}
          </div>
        )}
        <div className="Exchange-swap-button-container">
          <button className="App-cta Exchange-swap-button" onClick={onClickPrimary} disabled={!isPrimaryEnabled()}>
    ...
    <SEO title={getPageTitle("Earn")}>
      <div className="StakeModal">
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          ...
          <div style={{ padding: "0 10px" }} className="Exchange-info-row">
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <div style={{ padding: "30px", maxWidth: "450px" }}>
          <div>
            ...
            <br />
            <br />
            For claiming unvested MVX tokens without withdrawing, use the "CLAIM" button under the "Total Earnings"
            section.
            <br />
            <br />
          </div>
...
function CompoundModal(props) {
  ...
  const [shouldAddIntoMVLP, setShouldAddIntoMVLP] = useLocalStorageSerializeKey(
    [chainId, "StakeV2-compound-should-add-into-mvlp"],
    false
  );

  const [shouldConvertMvxAndStake, setShouldConvertMvxAndStake] = useLocalStorageSerializeKey(
    [chainId, "StakeV2-compound-should-convert-mvx-and-stake"],
    false
  );
  ...
  const toggleClaimWeth = (value) => {
    if (!value) {
      ...
      setShouldAddIntoMVLP(false);
      setShouldConvertMvxAndStake(false);
    }
    ...
    <div className="StakeModal">
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label="Compound Rewards">
        <div className="CompoundModal-menu query-modal">
          ...
          <div>
            <Checkbox isChecked={shouldAddIntoMVLP} setIsChecked={toggleAddIntoMVLP}>
              <span style={{ marginLeft: 5 }}>Compound {wrappedTokenSymbol} into MVLP</span>
            </Checkbox>
          </div>
          <div>
            <Checkbox isChecked={shouldConvertMvxAndStake} setIsChecked={toggleConvertMvxAndStake}>
              <span style={{ marginLeft: 5 }}>Compound {wrappedTokenSymbol} into MVX</span>
            </Checkbox>
          </div>
        </div>
        <div className="Exchange-swap-button-container">
  ...
  const onClickPrimary = () => {
    ...
    callContract(
      ...
      [
        ...
        shouldClaimWeth,
        shouldConvertWeth,
        false, //shouldAddIntoMVLP
        false, //shouldConvertMvxAndStake
      ],
      {
  ...
  return (
    <div className="StakeV2 Page page-layout">
      ...
      <div className="Page-title-section marginbottommedia">
        <div className="section-title-block2 sectionsmallscreen">
        ...
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-mvx-card">
            <div
              ...
              className="App-card-title flex-title"
            >
              <img
              ...
              />
              MVX
              <Link className="buy-mvx--btn" style={{marginLeft:"auto"}} to="/buy_mvx">
                Buy MVX
              </Link>
            </div>
            <div className="App-card-divider"></div>
            <div style={{ paddingBottom: 30 }} className="App-card-content padding-left">
              ...
              <div style={{ border: "none" }} className="App-card-row">
              ...
              <div className="critical-divider"></div>
            ...
            <div style={{ padding: "0 30px", marginTop: "auto" }} className="App-card-options flex-card">
              {/* <div style={{ margin: "0 auto", paddingRight: 30 }}>
              ...
              {active && (
                <button
                  className="App-button-option App-card-option btnwt query-button "
                  onClick={() => showStakeEsMvxModal()}
                >
                  Stake esMVX
                </button>
              )}
              {active && (
                <button
                  style={{ background: "#625DF5", color: "#fff" }}
                  className="App-button-option App-card-option btnwt purple-hover query-button"
                  onClick={() => showUnstakeEsMvxModal()}
                >
                  Unstake esMVX
                </button>
              )}
              ...
              {/* {active && <div className="App-card-divider"></div>} */}
              {/* {active && (
                  <Link className="App-button-option App-card-option gradient" to="/begin_account_transfer">
                    Transfer Account
                  </Link>
                )} */}
            </div>
          ...
          <div className="StakeV2-mvx-card">
            <div className="App-card  ">
              <div
                style={{ justifyContent: "start", display: "flex", alignItems: "center", padding: "20px" }}
                className="App-card-title flex-title"
              >
                <img
                  style={{ width: 60, height: 60, marginRight: 16 }}
                ...
                <div style={{ marginLeft: "auto", display:"flex", flexDirection: "column", alignItems:"flex-end" }}>
                  <span style={{ fontSize: "15px", fontWeight: 600, color: "rgba(255, 255, 255, 0.5)" }}>
                    Amplify your MVLP yield on
                  </span>
                  <a
                    className="buy-mvx--btn"
                    style={{ display: "flex", alignItems: "center", gap: "8px" }}
                    href="https://oliveapp.finance/earn/vaults/mvlp-high-yield-polygon"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img src={OliveSvg} alt="Olive Finnance"></img>
                    Olive Finance
                  </a>
                </div>
              </div>
              <div className="App-card-divider"></div>
              <div style={{ paddingBottom: "30px" }} className="App-card-content padding-left">
                <div className="App-card-row">
                  <div className="label">MVLP Price</div>
                  <div>
                    ${formatKeyAmount(processedData, "mvlpPrice", USD_DECIMALS, MVXMVLP_DISPLAY_DECIMALS, true)}
                  </div>
                </div>
                <div style={{ border: "none" }} className="App-card-row">
                ...
                <div style={{ paddingLeft: 0 }} className="App-card-options">
                  <div style={{ marginLeft: 0, marginRight: 0, paddingLeft: 0 }} className="stake-cta2">
                    <Link
                      style={{ marginLeft: 0 }}
                      className="App-button-option App-card-option btnwt text-center stake-cta4"
                      to="/buy_mvlp"
                    >
                      + LIQ.
                    </Link>
                    <Link
                      style={{ background: "#625DF5", color: "#fff", marginLeft: 0, marginRight: 0 }}
                      className="App-button-option App-card-option btnwt text-center stake-cta3 purple-hover"
                      to="/buy_mvlp#redeem"
                    >
                      - LIQ.
                    </Link>
            ...
            <div
              ...
              className="App-card primary StakeV2-total-rewards-card mt-3"
            >
              <div style={{ justifyContent: "flex-start" }} className="App-card-title flex-title">
                <div style={{ width: 60, height: 60 }}>
                  <img
                    width={60}
                    height={60}
                    src={getImageUrl({
                      path: "app.metavault.trade/earn-icon--coin",
                      format: "png",
                    })}
                    alt=""
                  />
              ...
              <div style={{ paddingLeft: 30 }} className="App-card-bottom">
                {/* <div className="App-card-divider"></div> */}
                <div style={{ paddingRight: 30, margin: 0, paddingLeft: 0 }} className="App-card-options total-cta">
                  {active && (
                    <button
                  ...
                  {active && (
                    <button
                      style={{ marginLeft: 0, marginRight: 0 }}
                      className="App-button-option App-card-option btnwt secondary-color purple-hover"
                  ...
                  {!active && (
                    <div style={{ width: "100%" }}>
                      <button
                        style={{ marginLeft: 0, marginRight: 0 }}
                        className="App-button-option App-card-option px-4 pe-4"
      ...
      <div>
        {/* <div style={{ display: "flex", alignItems: "center", gap: 15 }}>
          <VestingIcon width={120} height={120} />
          <div className="Page-title-section">
            ...
            <div className="Page-description">
              ...
              Please read the{" "}
              <a
                href="https://docs.metavault.trade/rewards#vesting"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="section-title-block2 sectionsmallscreen">
          <div className="section-title-icon section-title-icontablet section-title-iconsmall">
            <img
              ...
              height={116}
              src={getImageUrl({
                path: "app.metavault.trade/vesting-icon",
                format: "png",
                width: 116,
                height: 116,
              })}
        ...
        <div>
          <div className="StakeV2-cards">
            <div style={{ paddingBottom: 30, justifyContent: "space-between" }} className="App-card StakeV2-mvx-card">
              <div style={{ justifyContent: "flex-start" }} className="App-card-title flex-title">
                <img
                  width={60}
                  src={getImageUrl({
                    path: "app.metavault.trade/mvx-vault",
                    format: "png",
                  })}
                  alt="MVX VAULT"
                />
              ...
              <div className="App-card-content">
                ...
                {/* <div className="App-card-divider"></div> */}
                <div style={{ paddingLeft: 0 }} className="App-card-options options-2">
                  {!active && (
                    <button
                  ...
                  {active && (
                    <button
                      style={{ marginRight: 0, marginLeft: 0 }}
                      className="App-button-option App-card-option"
                      onClick={() => showMvxVesterDepositModal()}
                    >
                      Deposit
                    </button>
                  )}
                  {active && (
                    <button
                      style={{ marginRight: 0, marginLeft: 0 }}
                      className="App-button-option App-card-option withdraw purple-hover"
                      onClick={() => showMvxVesterWithdrawModal()}
                    >
                      Withdraw
                    </button>
                  )}
            ...
            <div className="App-card StakeV2-mvx-card">
              <div style={{ justifyContent: "flex-start" }} className="App-card-title flex-title">
                <img
                  width={60}
                  src={getImageUrl({
                    path: "app.metavault.trade/mvlp-vault",
                    format: "png",
                  })}
                  alt="MVLP VAULT"
                />
              ...
              <div className="App-card-content">
                ...
                <div style={{ paddingLeft: 0 }} className="App-card-options options-2">
                  {!active && (
                    <button
                      style={{ marginLeft: 0, marginRight: 0, marginTop: 6.2, marginBottom: 6.2 }}
                      className="App-button-option App-card-option"
                      onClick={() => connectWallet()}
                    >
                      Connect Wallet
                  ...
                  {active && (
                    <button
                      style={{ marginLeft: 0, marginRight: 0, marginTop: 6.2, marginBottom: 6.2 }}
                      className="App-button-option App-card-option"
                      onClick={() => showMvlpVesterDepositModal()}
                    >
                      Deposit
                    </button>
                  )}
                  {active && (
                    <button
                      style={{ marginLeft: 0, marginRight: 0, marginTop: 6.2, marginBottom: 6.2 }}
                      className="App-button-option App-card-option withdraw purple-hover"
                      onClick={() => showMvlpVesterWithdrawModal()}
                    >
                      Withdraw
                    </button>
                  )}
